...
import Lib.Create_Exception.InvalidOperationException;
import Lib.Create_Exception.ProductNotFoundException;
...
public class ShoppingCart {
     ...
     * @throws ProductNotFoundException if not found product in catalog
     */
    public void addItem(String productId, int quantity) throws ProductNotFoundException {
        ...
        if (quantity <= 0) {
            // use Unchecked Exception to excepting of Program (Precondition violation)
     ...
     * @throws InvalidOperationException if Not found Product in shoppingCart
     */
    public void removeItem(String productId) throws InvalidOperationException {
        if (productId == null) throw new RuntimeException("Product ID is null.");
        ...
        } else { // if loop is end and not found be throws exception 
